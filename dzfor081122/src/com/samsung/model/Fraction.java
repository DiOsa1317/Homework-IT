...
public class Fraction {
    ...
    public Fraction difFraction(Fraction obj1, Fraction obj2){ // difference?
        return new Fraction(obj1.numerator * obj2.denominator - obj2.numerator * obj1.denominator, obj1.denominator * obj2.denominator);
    }

    public Fraction multiFraction(Fraction obj1, Fraction obj2){ // multiplication?
        return new Fraction(obj1.numerator * obj2.numerator, obj1.denominator * obj2.denominator);
    }

    public Fraction divFraction(Fraction obj1, Fraction obj2){ // division?
